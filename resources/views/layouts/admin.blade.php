...
<body>
  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="dropdown active">
              <a href="{{ route('admin.attribute.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Attributes</span></a>
            </li>
          </ul>

          <ul class="sidebar-menu">
            <li class="dropdown active">
              <a href="{{ route('admin.variants.index') }}" class="nav-link"><i data-feather="monitor"></i><span>Variants</span></a>
            </li>
          </ul>
        </aside>
      </div>
    ...
    <!-- Template JS File -->
    <script src="/admin/assets/bundles/dropzonejs/min/dropzone.min.js"></script>
    <!-- Page Specific JS File -->
    <script src="/admin/assets/js/page/multiple-upload.js"></script>
    <!-- Template JS File -->
